...
import { type ContestEntry } from '@/ai/flows/ai-conflict-detection-flow';
...
interface ContestFormProps {
  onSubmit: (contest: ContestEntry) => void;
}

export default function ContestForm({ onSubmit }: ContestFormProps) {
